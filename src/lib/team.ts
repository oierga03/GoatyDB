/// Datos del equipo Goaty Esports y enlaces de comunidad.
/// Los avatares son opcionales: si el archivo no existe todavía en
/// public/team/, se muestra la inicial en un círculo de color (fallback).
...
export type Social = {
  ...
  sub: string;
  href: string;
  path: string; // path SVG del icono (viewBox 0 0 24 24)
};
